...
anno = json.load(open("/mnt/data/experiments/datasets/spinal2023/spinal2023_train17_new.json"))['annotations']
resample_lines = []
...
output_path = os.path.join('./eigenanchors/pca_spinal2023_' +str(n_components)
                            + '.npz')
