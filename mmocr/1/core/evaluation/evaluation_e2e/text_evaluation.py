...
class TextEvaluator():
    ...
    def __init__(self, dataset_name, cfg, distributed, output_dir=None):
        ...
        if "totaltext" in dataset_name:
            ...
            self._text_eval_gt_path = "mmocr/core/evaluation/evaluation_e2e/datasets/evaluation/gt_custom.zip"
            self._word_spotting = False
        else:
            self._text_eval_gt_path = "mmocr/core/evaluation/evaluation_e2e/datasets/evaluation/gt_custom.zip"
            self._word_spotting = False
    ...
    def evaluate(self):
        file_path = os.path.join(self._output_dir, "my_text_results.json")
        ...
        result_path = self.sort_detection(temp_dir)#琛 输出为“det.zip”
