...
class IcdarE2EDataset(IcdarDataset):
    ...
    def __getitem__(self, idx):
        ...
        while True:
            try:
                # if self.data_infos[idx]['id'] in self.discard:
                ...
                print("Exception:", e)
                print("hahahahahahahahahhahahaahhahahahah")
                print(idx)
                print(self.data_infos[idx])
    ...
    def evaluate(self,
        ...
        # print(len(results))
        # print(results[0])
        # print(results[0]['boundary_result'])
        # print(results)#{'boundary_result': [], 'scales': (8, 16, 32)},
